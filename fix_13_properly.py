...
# 13_병자.json의 각 항목별 맞춤 액션 작성
# 병자의 특성: 순수한 이상주의, 바른 원칙, 예의 바름, 반듯함

custom_actions = {
    # 장생
    ("장생", 1): "시작하세요. 순수한 마음으로 새로운 일을, 정직하게 첫걸음을 내딛으세요.",
    ("장생", 2): "행동하세요. 반듯한 모습으로 에너지를, 세상에 활짝 펼쳐보세요.",
    ("장생", 3): "감사하세요. 후원에 진심으로, 예의 바르게 마음을 전하세요.",
    ("장생", 4): "전진하세요. 순수한 열정으로 흔들림 없이, 당당하게 밀고 나가세요.",
    ("장생", 5): "회복하세요. 맑은 마음으로 긍정의 에너지를, 차분히 받아들이세요.",
    ("장생", 6): "소통하세요. 예의 바른 태도로, 사람들과 진심으로 연결되세요.",
    ("장생", 7): "성장하세요. 올바른 방향으로 꾸준히, 차근차근 나아가세요.",
    ("장생", 8): "빛나세요. 태양처럼 세상을 밝히며, 희망을 전하세요.",
    ("장생", 9): "세우세요. 바른 원칙의 씨앗을 정직하게, 단단히 심으세요.",
    ("장생", 10): "출발하세요. 이상을 향해 순수한 마음으로, 힘차게 떠나세요.",

    # 목욕
    ("목욕", 1): "느끼세요. 감각을 열어 아름다움을, 순수하게 즐기세요.",
    ("목욕", 2): "드러내세요. 매력을 예의 바르게, 자신 있게 보여주세요.",
    ("목욕", 3): "시도하세요. 새로운 변화를 정직하게, 신선하게 경험하세요.",
    ("목욕", 4): "받아들이세요. 감정의 물결을 있는 그대로, 차분히 느껴보세요.",
    ("목욕", 5): "돌보세요. 자신을 소중히 여기며, 정성껏 휴식을 주세요.",
    ("목욕", 6): "주목하세요. 예민한 직관으로, 섬세하게 살피세요.",
    ("목욕", 7): "표현하세요. 생각을 정중하게, 세련되게 드러내세요.",
    ("목욕", 8): "조절하세요. 감정 기복을 차분히 다스리며, 중심을 잡으세요.",
    ("목욕", 9): "빛내세요. 화려함을 품위 있게, 절제하며 드러내세요.",
    ("목욕", 10): "지키세요. 순수함을 소중히, 흔들림 없이 유지하세요.",

    # 관대
    ("관대", 1): "성장하세요. 올바른 길로 도전하며, 한 단계씩 올라가세요.",
    ("관대", 2): "준비하세요. 계획을 꼼꼼히 세우고, 철저히 마무리하세요.",
    ("관대", 3): "책임지세요. 맡은 일을 성실하게, 정직하게 완수하세요.",
    ("관대", 4): "인정받으세요. 실력을 정직하게 보여주며, 신뢰를 얻으세요.",
    ("관대", 5): "자립하세요. 스스로 서는 힘을 바르게, 당당히 키우세요.",
    ("관대", 6): "발휘하세요. 실력을 예의 바르게, 자신 있게 드러내세요.",
    ("관대", 7): "확립하세요. 위치를 반듯하게, 단단히 다지세요.",
    ("관대", 8): "품으세요. 군자의 품격을 지키며, 올바르게 행동하세요.",
    ("관대", 9): "이기세요. 원칙을 끝까지 지키며, 당당히 승리하세요.",
    ("관대", 10): "밝히세요. 등불처럼 세상을, 정직하게 비추세요.",

    # 건록
    ("건록", 1): "유지하세요. 안정을 차분히 지키며, 꾸준히 나아가세요.",
    ("건록", 2): "발휘하세요. 실력을 정직하게, 확실히 보여주세요.",
    ("건록", 3): "자급하세요. 스스로 해결하는 힘을 바르게, 키워가세요.",
    ("건록", 4): "거두세요. 근면한 노력의 결실을 당당히, 누리세요.",
    ("건록", 5): "균형잡으세요. 일과 휴식의 조화를 정직하게, 맞춰가세요.",
    ("건록", 6): "인정받으세요. 전문성을 성실히 쌓아, 존경을 얻으세요.",
    ("건록", 7): "다지세요. 기반을 차근차근, 단단히 쌓아가세요.",
    ("건록", 8): "집중하세요. 원칙을 지키며 일에, 몰입하세요.",
    ...
    ("제왕", 3): "빛나세요. 완벽한 컨디션으로 오늘을, 최선을 다해 보내세요.",
    ("제왕", 4): "확대하세요. 영향력을 책임감 있게, 바르게 넓히세요.",
    ...
    ("병", 3): "공감하세요. 동정심을 발휘해 타인을, 진심으로 이해하세요.",
    ("병", 4): "표현하세요. 예술적 감성으로 아름다움을, 정성껏 만드세요.",
    ...
    ("태", 9): "품으세요. 고요히 새로움을 키우며, 때를 기다리세요.",
...
print(f"{'='*60}")
print(f"✅ 13_병자.json 정성스럽게 수정 완료!")
print(f"{'='*60}")
