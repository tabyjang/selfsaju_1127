...
# 14_병인.json의 각 항목별 맞춤 액션 작성
# 병인의 특성: 열정, 순수한 영혼, 창의적 지혜, 희망, 생명력, 인간 비타민

custom_actions = {
    # 장생
    ("장생", 1): "시작하세요. 밝은 에너지로 새로운 일을, 열정적으로 첫걸음을 내딛으세요.",
    ("장생", 2): "행동하세요. 넘치는 활력을 마음껏 발산하며, 세상을 밝게 비추세요.",
    ("장생", 3): "감사하세요. 후원에 따뜻한 마음으로, 진심을 환하게 전하세요.",
    ("장생", 4): "전진하세요. 순수한 열정으로 흔들림 없이, 힘차게 밀고 나가세요.",
    ("장생", 5): "회복하세요. 긍정의 에너지로 활력을, 빠르게 되찾으세요.",
    ("장생", 6): "소통하세요. 밝은 미소로 사람들과, 따뜻하게 연결되세요.",
    ("장생", 7): "성장하세요. 창의적 지혜로 한 걸음씩, 즐겁게 나아가세요.",
    ("장생", 8): "빛나세요. 아침 해처럼 희망을 주며, 세상을 환하게 밝히세요.",
    ("장생", 9): "뿌리세요. 열정의 씨앗을 곳곳에, 생명력 넘치게 심으세요.",
    ("장생", 10): "시작하세요. 순수한 마음으로 새로운 여정을, 활기차게 떠나세요.",

    # 목욕
    ("목욕", 1): "만끽하세요. 감각을 활짝 열어 아름다움을, 순수하게 즐기세요.",
    ("목욕", 2): "드러내세요. 매력을 밝게 발산하며, 자신 있게 빛내세요.",
    ("목욕", 3): "시도하세요. 새로운 변화를 창의적으로, 신나게 경험하세요.",
    ("목욕", 4): "느끼세요. 감정의 흐름을 자연스럽게, 솔직하게 받아들이세요.",
    ("목욕", 5): "돌보세요. 자신을 따뜻하게 보듬으며, 충분히 쉬어가세요.",
    ("목욕", 6): "주목하세요. 예민한 직관으로 주변을, 섬세하게 관찰하세요.",
    ("목욕", 7): "표현하세요. 생각을 창의적으로, 활기차게 전하세요.",
    ("목욕", 8): "밝게 하세요. 감정 기복을 긍정으로 바꾸며, 햇살처럼 빛나세요.",
    ("목욕", 9): "즐기세요. 화려한 순간을 마음껏, 열정적으로 누리세요.",
    ("목욕", 10): "지키세요. 순수함을 소중히 여기며, 환하게 유지하세요.",

    # 관대
    ("관대", 1): "성장하세요. 열정을 담아 도전하며, 한 단계씩 올라가세요.",
    ("관대", 2): "준비하세요. 창의적으로 계획을 세우고, 완벽히 마무리하세요.",
    ("관대", 3): "책임지세요. 맡은 일을 성실하게, 밝은 에너지로 완수하세요.",
    ("관대", 4): "인정받으세요. 실력을 솔직하게 보여주며, 신뢰를 얻으세요.",
    ("관대", 5): "자립하세요. 스스로 서는 힘을 열정적으로, 키워나가세요.",
    ("관대", 6): "발휘하세요. 실력을 자신 있게 드러내며, 활약하세요.",
    ("관대", 7): "확립하세요. 위치를 단단히 다지며, 빛을 발하세요.",
    ...
    ("건록", 3): "자급하세요. 스스로 해결하는 힘을 긍정적으로, 키우세요.",
...
print(f"{'='*60}")
print(f"✅ 14_병인.json 정성스럽게 수정 완료!")
print(f"{'='*60}")
